<?php
	...
	if (isset($_GET['id_factura']))
	{
		...
		{
			header("location: ../../vista/php/admin/facturacion.php");
			exit;	
		}
	} 
	else 
...
<div class="container">
	...
	<script type="text/javascript" src="../../vistajs/VentanaCentrada.js"></script>
	<script type="text/javascript" src="../../vista/js/editar_factura.js"></script>
